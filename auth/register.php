...
<body class="hold-transition login-p" style="background-image: url(' ../img/sapi.jpg'); background-size: cover; background-repeat: no-repeat; overflow: hidden;">
    <div class="login-box" style="margin-top: 26pt;">
        <div class="login-logo">
            <span class="text-white" href="#"><b>Website</b>Peminjaman Kendaraan<b>Tambang</b></span>
        </div>
        <!-- /.login-logo -->
        <?php
        ...
        if (isset($_POST['register'])) {
            ...
            $sql = mysqli_query($con, "INSERT INTO tb_user VALUES ('','$fullname','$username','$password','$level','$jabatan')");
