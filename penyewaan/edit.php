                    ...
                    <form action="proses.php" method="post" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="merk" name="merk" type="text" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="Jenis Kendaraan" class="col-sm-2 control-label">Jenis Kendaraan</label>
                                <div class="col-sm-10">
                                    <input id="jenis" name="jenis" type="text" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="Driver" class="col-sm-2 control-label">Driver</label>
                                <div class="col-sm-10">
                                    <input id="driver" value="<?= $dt['driver'] ?>" name="driver" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="persetujuan" type="text" value="<?= $dt['persetujuan'] ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="Tanggal Pinjam" class="col-sm-2 control-label">Tanggal Pinjam</label>
                                <div class="col-sm-10">
                                    <input name="pinjam" value="<?= $dt['tanggal_sewa'] ?>" type="date" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="Tanggal Kembali" class="col-sm-2 control-label">Tanggal Kembali</label>
                                <div class="col-sm-10">
                                    <input name="kembali" value="<?= $dt['tanggal_kembali'] ?>" type="date" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="Keterangan" class="col-sm-2 control-label">Keterangan</label>
                                <div class="col-sm-10">
                                    <textarea name="keterangan" id="" class="form-control"><?= $dt['keterangan'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
