    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Data Belum Disetujui</h3>
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql_a = mysqli_query($con, "SELECT * FROM tb_penyewa where persetujuan = 'Belum Disetujui'") or die(mysqli_error($con));
            ...
            <div class="col-md-12">
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Data Disetujui</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                        </div>
                    ...
                    <div class="box-body table-responsive">
                        <table id="example2" class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql_a = mysqli_query($con, "SELECT * FROM tb_penyewa where persetujuan = 'Disetujui'") or die(mysqli_error($con));
                                if (mysqli_num_rows($sql_a) > 0) {
                                    while ($data = mysqli_fetch_array($sql_a)) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
